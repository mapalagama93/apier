...
class RequestExecuter:
    ...
    def log_response(self):
        ...
        print(colored('Response Body', 'magenta', attrs=['bold']), '\n', json.dumps(self.response['data'], indent=2) if self.isJsonResponse() and self.response['json'] else self.response['data'])
        print('\n')
